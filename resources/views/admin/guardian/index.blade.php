                        ...
                        <tr class="{{ $loop->even ? 'bg-neutral-100' : 'bg-neutral-200' }} h-10 text-neutral-600 divide-x-2 divide-white">
                            ...
                            <td class="px-2 sm:px-4 py-1 min-h-10 text-nowrap">
                                <div x-data="{ copied: false, original: '{{$item->code}}' }" 
                                    ...
                                    <p class=" w-[118px] hidden sm:block" x-text="copied ? 'Sudah disalin' : original"></p>
                                    <button 
                                        @click="navigator.clipboard.writeText(original).then(() => { 
                                                    copied = true; 
                                                    setTimeout(() => copied = false, 1000); 
                                                })"
                                        class="w-4 aspect-square duration-300"
                                        :class="copied ? ' text-green-500' : ''"
                                        :aria-label="copied ? 'Sudah Disalin' : 'salin kode'">
                                        <svg viewBox="0 0 21 22" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M14.5 0h-12C1.4 0 .5.9.5 2v14h2V2h12V0Zm3 4h-11c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2Zm0 16h-11V6h11v14Z" 
