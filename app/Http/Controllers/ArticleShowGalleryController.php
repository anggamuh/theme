...
class ArticleShowGalleryController extends Controller
{
    /**
        ...
        if ($request->hasFile('image_gallery')) {
            ...
            if ($image instanceof \Illuminate\Http\UploadedFile && $image->isValid()) {
                try {
                    ...
                    $newArticleShowImage = new ArticleShowGallery;

                    $newArticleShowImage->article_show_id = $request->article_show_id;
                    $newArticleShowImage->article_gallery_id = $newImage->id;
                    $newArticleShowImage->image = $newImage->image;
                    $newArticleShowImage->image_alt = $newImage->image_alt;

                    $newArticleShowImage->save();
     ...
     */
    public function show(ArticleShowGallery $articleShowGallery)
    {
        //
    }
     ...
     */
    public function edit(ArticleShowGallery $articleShowGallery)
    {
        //
    }
     ...
     */
    public function update(Request $request, ArticleShowGallery $articleShowGallery)
    {
        //
    }
