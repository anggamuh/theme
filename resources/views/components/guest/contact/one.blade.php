<div class=" w-full sticky px-4 bottom-0 z-10 backdrop-blur">
    <div class=" w-full max-w-[600px] mx-auto">
        <div class=" w-full py-2 grid grid-cols-2 gap-2 sm:gap-4 text-sm sm:text-base">
            <a href="">
                <button class=" w-full flex items-center justify-center gap-0.5 sm:gap-1.5 bg-[#1d588d] py-2 text-white rounded-full hover:scale-95 duration-300">
            ...
            <a href="">
                <button class=" w-full flex items-center justify-center gap-0.5 sm:gap-1.5 bg-[#25d366] py-2 text-white rounded-full hover:scale-95 duration-300">
                    <div class=" w-4 sm:w-5 aspect-square">
